...
public class DBAdapter {
    ...
    private static final String DATABASE_COMPANIES =
            "create table COMPANIES (cmp_id integer primary key autoincrement,cmp_name text,cmp_address text,cmp_contact text,cmp_weburl text,cmp_notes text);";
    ...
    public boolean updateCompanies(long cmp_id, String name, String add, String contact, String url, String notes) {
        ContentValues initialValues = new ContentValues();

        initialValues.put("cmp_name", name);//1
        initialValues.put("cmp_address", add);//2
        initialValues.put("cmp_contact", contact);
    ...
    public long insertCompanies(String name, String add, String contact, String url, String notes) {
        ContentValues initialValues = new ContentValues();
    ...
    public long insertClaims(String pname, String date, String amt, String ampuntPaid, String status, String fullDate, String notes, byte[] img) {
        ContentValues initialValues = new ContentValues();
    ...
    public boolean updateClaims(long clm_id, String pname, String date, String amt, String ampuntPaid, String time, String fullDate, String notes, byte[] image) {
        ContentValues initialValues = new ContentValues();
